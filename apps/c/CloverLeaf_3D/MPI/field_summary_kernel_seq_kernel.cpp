...
void ops_par_loop_field_summary_kernel(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg8, ops_arg arg9, ops_arg arg10, ops_arg arg11) {
  ...
  #ifdef OPS_MPI
  p_a[8] = ((ops_reduction)args[8].data)->data + ((ops_reduction)args[8].data)->size * block->index;
  #else //OPS_MPI
  ...
  #ifdef OPS_MPI
  p_a[9] = ((ops_reduction)args[9].data)->data + ((ops_reduction)args[9].data)->size * block->index;
  #else //OPS_MPI
  ...
  #ifdef OPS_MPI
  p_a[10] = ((ops_reduction)args[10].data)->data + ((ops_reduction)args[10].data)->size * block->index;
  #else //OPS_MPI
  ...
  #ifdef OPS_MPI
  p_a[11] = ((ops_reduction)args[11].data)->data + ((ops_reduction)args[11].data)->size * block->index;
  #else //OPS_MPI
  p_a[11] = ((ops_reduction)args[11].data)->data;
  #endif //OPS_MPI
    ...
    for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
      ...
      for( n_x=start[0]; n_x<start[0]+((end[0]-start[0])/SIMD_VEC)*SIMD_VEC; n_x+=SIMD_VEC ) {
        ...
        for ( int i=0; i<SIMD_VEC; i++ ){
          field_summary_kernel(  (double *)p_a[0]+ i*1*1, (double *)p_a[1]+ i*1*1, (double *)p_a[2]+ i*1*1,
