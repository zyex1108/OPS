...
extern int xdim0_update_halo_kernel2_yvel_minus_4_bot;
int xdim0_update_halo_kernel2_yvel_minus_4_bot_h = -1;
extern int ydim0_update_halo_kernel2_yvel_minus_4_bot;
int ydim0_update_halo_kernel2_yvel_minus_4_bot_h = -1;
extern int xdim1_update_halo_kernel2_yvel_minus_4_bot;
int xdim1_update_halo_kernel2_yvel_minus_4_bot_h = -1;
extern int ydim1_update_halo_kernel2_yvel_minus_4_bot;
...
void ops_par_loop_update_halo_kernel2_yvel_minus_4_bot(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  #ifdef CHECKPOINTING
  if (!ops_checkpointing_before(args,3,range,81)) return;
  #endif
  ...
  if (xdim0 != xdim0_update_halo_kernel2_yvel_minus_4_bot_h || ydim0 != ydim0_update_halo_kernel2_yvel_minus_4_bot_h || xdim1 != xdim1_update_halo_kernel2_yvel_minus_4_bot_h || ydim1 != ydim1_update_halo_kernel2_yvel_minus_4_bot_h) {
    xdim0_update_halo_kernel2_yvel_minus_4_bot = xdim0;
    xdim0_update_halo_kernel2_yvel_minus_4_bot_h = xdim0;
    ydim0_update_halo_kernel2_yvel_minus_4_bot = ydim0;
    ydim0_update_halo_kernel2_yvel_minus_4_bot_h = ydim0;
    xdim1_update_halo_kernel2_yvel_minus_4_bot = xdim1;
    xdim1_update_halo_kernel2_yvel_minus_4_bot_h = xdim1;
    ydim1_update_halo_kernel2_yvel_minus_4_bot = ydim1;
  ...
  update_halo_kernel2_yvel_minus_4_bot_c_wrapper(
    p_a0,
    p_a1,
    p_a2,
