...
extern int xdim0_update_halo_kernel1_ba2;
int xdim0_update_halo_kernel1_ba2_h = -1;
extern int ydim0_update_halo_kernel1_ba2;
int ydim0_update_halo_kernel1_ba2_h = -1;
extern int xdim1_update_halo_kernel1_ba2;
int xdim1_update_halo_kernel1_ba2_h = -1;
extern int ydim1_update_halo_kernel1_ba2;
int ydim1_update_halo_kernel1_ba2_h = -1;
extern int xdim2_update_halo_kernel1_ba2;
int xdim2_update_halo_kernel1_ba2_h = -1;
extern int ydim2_update_halo_kernel1_ba2;
int ydim2_update_halo_kernel1_ba2_h = -1;
extern int xdim3_update_halo_kernel1_ba2;
int xdim3_update_halo_kernel1_ba2_h = -1;
extern int ydim3_update_halo_kernel1_ba2;
int ydim3_update_halo_kernel1_ba2_h = -1;
extern int xdim4_update_halo_kernel1_ba2;
int xdim4_update_halo_kernel1_ba2_h = -1;
extern int ydim4_update_halo_kernel1_ba2;
int ydim4_update_halo_kernel1_ba2_h = -1;
extern int xdim5_update_halo_kernel1_ba2;
int xdim5_update_halo_kernel1_ba2_h = -1;
extern int ydim5_update_halo_kernel1_ba2;
int ydim5_update_halo_kernel1_ba2_h = -1;
extern int xdim6_update_halo_kernel1_ba2;
int xdim6_update_halo_kernel1_ba2_h = -1;
extern int ydim6_update_halo_kernel1_ba2;
int ydim6_update_halo_kernel1_ba2_h = -1;

#ifdef __cplusplus
extern "C" {
#endif
void update_halo_kernel1_ba2_c_wrapper(
  double *p_a0,
  double *p_a1,
  double *p_a2,
  double *p_a3,
...
void ops_par_loop_update_halo_kernel1_ba2(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2, ops_arg arg3, ops_arg arg4, ops_arg arg5, ops_arg arg6, ops_arg arg7) {
  ...
  #ifdef CHECKPOINTING
  if (!ops_checkpointing_before(args,8,range,65)) return;
  #endif
  ...
  if (xdim0 != xdim0_update_halo_kernel1_ba2_h || ydim0 != ydim0_update_halo_kernel1_ba2_h || xdim1 != xdim1_update_halo_kernel1_ba2_h || ydim1 != ydim1_update_halo_kernel1_ba2_h || xdim2 != xdim2_update_halo_kernel1_ba2_h || ydim2 != ydim2_update_halo_kernel1_ba2_h || xdim3 != xdim3_update_halo_kernel1_ba2_h || ydim3 != ydim3_update_halo_kernel1_ba2_h || xdim4 != xdim4_update_halo_kernel1_ba2_h || ydim4 != ydim4_update_halo_kernel1_ba2_h || xdim5 != xdim5_update_halo_kernel1_ba2_h || ydim5 != ydim5_update_halo_kernel1_ba2_h || xdim6 != xdim6_update_halo_kernel1_ba2_h || ydim6 != ydim6_update_halo_kernel1_ba2_h) {
    xdim0_update_halo_kernel1_ba2 = xdim0;
    xdim0_update_halo_kernel1_ba2_h = xdim0;
    ydim0_update_halo_kernel1_ba2 = ydim0;
    ydim0_update_halo_kernel1_ba2_h = ydim0;
    xdim1_update_halo_kernel1_ba2 = xdim1;
    xdim1_update_halo_kernel1_ba2_h = xdim1;
    ydim1_update_halo_kernel1_ba2 = ydim1;
    ydim1_update_halo_kernel1_ba2_h = ydim1;
    xdim2_update_halo_kernel1_ba2 = xdim2;
    xdim2_update_halo_kernel1_ba2_h = xdim2;
    ydim2_update_halo_kernel1_ba2 = ydim2;
    ydim2_update_halo_kernel1_ba2_h = ydim2;
    xdim3_update_halo_kernel1_ba2 = xdim3;
    xdim3_update_halo_kernel1_ba2_h = xdim3;
    ydim3_update_halo_kernel1_ba2 = ydim3;
    ydim3_update_halo_kernel1_ba2_h = ydim3;
    xdim4_update_halo_kernel1_ba2 = xdim4;
    xdim4_update_halo_kernel1_ba2_h = xdim4;
    ydim4_update_halo_kernel1_ba2 = ydim4;
    ydim4_update_halo_kernel1_ba2_h = ydim4;
    xdim5_update_halo_kernel1_ba2 = xdim5;
    xdim5_update_halo_kernel1_ba2_h = xdim5;
    ydim5_update_halo_kernel1_ba2 = ydim5;
    ydim5_update_halo_kernel1_ba2_h = ydim5;
    xdim6_update_halo_kernel1_ba2 = xdim6;
    xdim6_update_halo_kernel1_ba2_h = xdim6;
    ydim6_update_halo_kernel1_ba2 = ydim6;
  ...
  update_halo_kernel1_ba2_c_wrapper(
    p_a0,
    p_a1,
    p_a2,
    p_a3,
