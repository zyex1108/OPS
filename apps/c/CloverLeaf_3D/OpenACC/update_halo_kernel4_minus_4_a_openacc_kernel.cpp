...
extern int xdim0_update_halo_kernel4_minus_4_a;
int xdim0_update_halo_kernel4_minus_4_a_h = -1;
extern int ydim0_update_halo_kernel4_minus_4_a;
int ydim0_update_halo_kernel4_minus_4_a_h = -1;
extern int xdim1_update_halo_kernel4_minus_4_a;
int xdim1_update_halo_kernel4_minus_4_a_h = -1;
extern int ydim1_update_halo_kernel4_minus_4_a;
int ydim1_update_halo_kernel4_minus_4_a_h = -1;
...
void ops_par_loop_update_halo_kernel4_minus_4_a(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  #ifdef CHECKPOINTING
  if (!ops_checkpointing_before(args,3,range,117)) return;
  #endif

  if (OPS_diags > 1) {
    ops_timing_realloc(117,"update_halo_kernel4_minus_4_a");
  ...
  if (xdim0 != xdim0_update_halo_kernel4_minus_4_a_h || ydim0 != ydim0_update_halo_kernel4_minus_4_a_h || xdim1 != xdim1_update_halo_kernel4_minus_4_a_h || ydim1 != ydim1_update_halo_kernel4_minus_4_a_h) {
    xdim0_update_halo_kernel4_minus_4_a = xdim0;
    xdim0_update_halo_kernel4_minus_4_a_h = xdim0;
    ydim0_update_halo_kernel4_minus_4_a = ydim0;
    ydim0_update_halo_kernel4_minus_4_a_h = ydim0;
    xdim1_update_halo_kernel4_minus_4_a = xdim1;
    xdim1_update_halo_kernel4_minus_4_a_h = xdim1;
    ydim1_update_halo_kernel4_minus_4_a = ydim1;
    ydim1_update_halo_kernel4_minus_4_a_h = ydim1;
  }
