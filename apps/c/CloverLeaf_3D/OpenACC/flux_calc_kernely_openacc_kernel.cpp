...
void ops_par_loop_flux_calc_kernely(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2, ops_arg arg3) {
  ...
  #ifdef CHECKPOINTING
  if (!ops_checkpointing_before(args,4,range,43)) return;
  #endif
  ...
  if (xdim0 != xdim0_flux_calc_kernely_h || ydim0 != ydim0_flux_calc_kernely_h || xdim1 != xdim1_flux_calc_kernely_h || ydim1 != ydim1_flux_calc_kernely_h || xdim2 != xdim2_flux_calc_kernely_h || ydim2 != ydim2_flux_calc_kernely_h || xdim3 != xdim3_flux_calc_kernely_h || ydim3 != ydim3_flux_calc_kernely_h) {
    xdim0_flux_calc_kernely = xdim0;
    xdim0_flux_calc_kernely_h = xdim0;
    ydim0_flux_calc_kernely = ydim0;
    ydim0_flux_calc_kernely_h = ydim0;
    xdim1_flux_calc_kernely = xdim1;
    xdim1_flux_calc_kernely_h = xdim1;
    ydim1_flux_calc_kernely = ydim1;
    ydim1_flux_calc_kernely_h = ydim1;
    xdim2_flux_calc_kernely = xdim2;
    xdim2_flux_calc_kernely_h = xdim2;
    ydim2_flux_calc_kernely = ydim2;
    ydim2_flux_calc_kernely_h = ydim2;
    xdim3_flux_calc_kernely = xdim3;
    xdim3_flux_calc_kernely_h = xdim3;
    ydim3_flux_calc_kernely = ydim3;
    ydim3_flux_calc_kernely_h = ydim3;
  }
