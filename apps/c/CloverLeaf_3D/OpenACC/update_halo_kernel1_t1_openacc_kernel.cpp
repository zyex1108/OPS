...
void ops_par_loop_update_halo_kernel1_t1(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2, ops_arg arg3, ops_arg arg4, ops_arg arg5, ops_arg arg6, ops_arg arg7) {
  ...
  if (OPS_diags > 1) {
    ...
    OPS_kernels[60].transfer += ops_compute_transfer(dim, start, end, &arg4);
    OPS_kernels[60].transfer += ops_compute_transfer(dim, start, end, &arg5);
    OPS_kernels[60].transfer += ops_compute_transfer(dim, start, end, &arg6);
  }
}
