...
extern int xdim0_update_halo_kernel4_plus_2_back;
int xdim0_update_halo_kernel4_plus_2_back_h = -1;
extern int ydim0_update_halo_kernel4_plus_2_back;
int ydim0_update_halo_kernel4_plus_2_back_h = -1;
extern int xdim1_update_halo_kernel4_plus_2_back;
int xdim1_update_halo_kernel4_plus_2_back_h = -1;
extern int ydim1_update_halo_kernel4_plus_2_back;
...
void ops_par_loop_update_halo_kernel4_plus_2_back(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  #ifdef CHECKPOINTING
  if (!ops_checkpointing_before(args,3,range,126)) return;
  #endif

  if (OPS_diags > 1) {
    ops_timing_realloc(126,"update_halo_kernel4_plus_2_back");
  ...
  update_halo_kernel4_plus_2_back_c_wrapper(
    p_a0,
    p_a1,
    p_a2,
