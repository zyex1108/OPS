...
void ops_par_loop_update_halo_kernel2_xvel_plus_4_bot(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  if (xdim0 != xdim0_update_halo_kernel2_xvel_plus_4_bot_h || ydim0 != ydim0_update_halo_kernel2_xvel_plus_4_bot_h || xdim1 != xdim1_update_halo_kernel2_xvel_plus_4_bot_h || ydim1 != ydim1_update_halo_kernel2_xvel_plus_4_bot_h) {
    xdim0_update_halo_kernel2_xvel_plus_4_bot = xdim0;
    xdim0_update_halo_kernel2_xvel_plus_4_bot_h = xdim0;
    ydim0_update_halo_kernel2_xvel_plus_4_bot = ydim0;
    ydim0_update_halo_kernel2_xvel_plus_4_bot_h = ydim0;
    xdim1_update_halo_kernel2_xvel_plus_4_bot = xdim1;
    xdim1_update_halo_kernel2_xvel_plus_4_bot_h = xdim1;
    ydim1_update_halo_kernel2_xvel_plus_4_bot = ydim1;
