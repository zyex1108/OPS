...
extern int ydim0_update_halo_kernel3_plus_4_front;
int ydim0_update_halo_kernel3_plus_4_front_h = -1;
extern int xdim1_update_halo_kernel3_plus_4_front;
int xdim1_update_halo_kernel3_plus_4_front_h = -1;
extern int ydim1_update_halo_kernel3_plus_4_front;
int ydim1_update_halo_kernel3_plus_4_front_h = -1;

#ifdef __cplusplus
extern "C" {
#endif
void update_halo_kernel3_plus_4_front_c_wrapper(
  double *p_a0,
  double *p_a1,
  int *p_a2,
...
void ops_par_loop_update_halo_kernel3_plus_4_front(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  #ifdef CHECKPOINTING
  if (!ops_checkpointing_before(args,3,range,115)) return;
  #endif
  ...
  if (xdim0 != xdim0_update_halo_kernel3_plus_4_front_h || ydim0 != ydim0_update_halo_kernel3_plus_4_front_h || xdim1 != xdim1_update_halo_kernel3_plus_4_front_h || ydim1 != ydim1_update_halo_kernel3_plus_4_front_h) {
    xdim0_update_halo_kernel3_plus_4_front = xdim0;
    xdim0_update_halo_kernel3_plus_4_front_h = xdim0;
    ydim0_update_halo_kernel3_plus_4_front = ydim0;
    ydim0_update_halo_kernel3_plus_4_front_h = ydim0;
    xdim1_update_halo_kernel3_plus_4_front = xdim1;
    xdim1_update_halo_kernel3_plus_4_front_h = xdim1;
    ydim1_update_halo_kernel3_plus_4_front = ydim1;
  ...
  update_halo_kernel3_plus_4_front_c_wrapper(
    p_a0,
    p_a1,
    p_a2,
