...
extern int xdim0_update_halo_kernel2_zvel_minus_2_back;
int xdim0_update_halo_kernel2_zvel_minus_2_back_h = -1;
extern int ydim0_update_halo_kernel2_zvel_minus_2_back;
int ydim0_update_halo_kernel2_zvel_minus_2_back_h = -1;
extern int xdim1_update_halo_kernel2_zvel_minus_2_back;
int xdim1_update_halo_kernel2_zvel_minus_2_back_h = -1;
extern int ydim1_update_halo_kernel2_zvel_minus_2_back;
int ydim1_update_halo_kernel2_zvel_minus_2_back_h = -1;

#ifdef __cplusplus
extern "C" {
#endif
void update_halo_kernel2_zvel_minus_2_back_c_wrapper(
  double *p_a0,
  double *p_a1,
  int *p_a2,
