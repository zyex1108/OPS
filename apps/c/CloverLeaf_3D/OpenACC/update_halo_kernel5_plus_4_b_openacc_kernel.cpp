...
int xdim0_update_halo_kernel5_plus_4_b_h = -1;
extern int ydim0_update_halo_kernel5_plus_4_b;
int ydim0_update_halo_kernel5_plus_4_b_h = -1;
extern int xdim1_update_halo_kernel5_plus_4_b;
int xdim1_update_halo_kernel5_plus_4_b_h = -1;
extern int ydim1_update_halo_kernel5_plus_4_b;
int ydim1_update_halo_kernel5_plus_4_b_h = -1;
...
void ops_par_loop_update_halo_kernel5_plus_4_b(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  #ifdef CHECKPOINTING
  if (!ops_checkpointing_before(args,3,range,131)) return;
  #endif

  if (OPS_diags > 1) {
    ops_timing_realloc(131,"update_halo_kernel5_plus_4_b");
  ...
  if (xdim0 != xdim0_update_halo_kernel5_plus_4_b_h || ydim0 != ydim0_update_halo_kernel5_plus_4_b_h || xdim1 != xdim1_update_halo_kernel5_plus_4_b_h || ydim1 != ydim1_update_halo_kernel5_plus_4_b_h) {
    xdim0_update_halo_kernel5_plus_4_b = xdim0;
    xdim0_update_halo_kernel5_plus_4_b_h = xdim0;
    ydim0_update_halo_kernel5_plus_4_b = ydim0;
    ydim0_update_halo_kernel5_plus_4_b_h = ydim0;
    xdim1_update_halo_kernel5_plus_4_b = xdim1;
    xdim1_update_halo_kernel5_plus_4_b_h = xdim1;
    ydim1_update_halo_kernel5_plus_4_b = ydim1;
    ydim1_update_halo_kernel5_plus_4_b_h = ydim1;
  }
