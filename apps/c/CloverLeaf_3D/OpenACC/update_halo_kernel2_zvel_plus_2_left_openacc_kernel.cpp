...
extern int xdim0_update_halo_kernel2_zvel_plus_2_left;
int xdim0_update_halo_kernel2_zvel_plus_2_left_h = -1;
extern int ydim0_update_halo_kernel2_zvel_plus_2_left;
int ydim0_update_halo_kernel2_zvel_plus_2_left_h = -1;
extern int xdim1_update_halo_kernel2_zvel_plus_2_left;
int xdim1_update_halo_kernel2_zvel_plus_2_left_h = -1;
extern int ydim1_update_halo_kernel2_zvel_plus_2_left;
int ydim1_update_halo_kernel2_zvel_plus_2_left_h = -1;
...
void ops_par_loop_update_halo_kernel2_zvel_plus_2_left(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  #ifdef CHECKPOINTING
  if (!ops_checkpointing_before(args,3,range,98)) return;
  #endif
