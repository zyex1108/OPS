...
extern int xdim0_update_halo_kernel5_minus_2_front;
int xdim0_update_halo_kernel5_minus_2_front_h = -1;
extern int ydim0_update_halo_kernel5_minus_2_front;
int ydim0_update_halo_kernel5_minus_2_front_h = -1;
extern int xdim1_update_halo_kernel5_minus_2_front;
int xdim1_update_halo_kernel5_minus_2_front_h = -1;
extern int ydim1_update_halo_kernel5_minus_2_front;
...
// host stub function
void ops_par_loop_update_halo_kernel5_minus_2_front(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  #ifdef CHECKPOINTING
  if (!ops_checkpointing_before(args,3,range,140)) return;
  #endif

  if (OPS_diags > 1) {
    ops_timing_realloc(140,"update_halo_kernel5_minus_2_front");
  ...
  if (xdim0 != xdim0_update_halo_kernel5_minus_2_front_h || ydim0 != ydim0_update_halo_kernel5_minus_2_front_h || xdim1 != xdim1_update_halo_kernel5_minus_2_front_h || ydim1 != ydim1_update_halo_kernel5_minus_2_front_h) {
    xdim0_update_halo_kernel5_minus_2_front = xdim0;
    xdim0_update_halo_kernel5_minus_2_front_h = xdim0;
    ydim0_update_halo_kernel5_minus_2_front = ydim0;
    ydim0_update_halo_kernel5_minus_2_front_h = ydim0;
    xdim1_update_halo_kernel5_minus_2_front = xdim1;
    xdim1_update_halo_kernel5_minus_2_front_h = xdim1;
    ydim1_update_halo_kernel5_minus_2_front = ydim1;
  ...
  update_halo_kernel5_minus_2_front_c_wrapper(
    p_a0,
    p_a1,
    p_a2,
