...
extern int xdim0_update_halo_kernel5_minus_4_back;
int xdim0_update_halo_kernel5_minus_4_back_h = -1;
extern int ydim0_update_halo_kernel5_minus_4_back;
int ydim0_update_halo_kernel5_minus_4_back_h = -1;
extern int xdim1_update_halo_kernel5_minus_4_back;
int xdim1_update_halo_kernel5_minus_4_back_h = -1;
extern int ydim1_update_halo_kernel5_minus_4_back;
int ydim1_update_halo_kernel5_minus_4_back_h = -1;

#ifdef __cplusplus
extern "C" {
#endif
void update_halo_kernel5_minus_4_back_c_wrapper(
  double *p_a0,
  double *p_a1,
  int *p_a2,
...
void ops_par_loop_update_halo_kernel5_minus_4_back(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  #ifdef CHECKPOINTING
  if (!ops_checkpointing_before(args,3,range,137)) return;
  #endif
  ...
  if (xdim0 != xdim0_update_halo_kernel5_minus_4_back_h || ydim0 != ydim0_update_halo_kernel5_minus_4_back_h || xdim1 != xdim1_update_halo_kernel5_minus_4_back_h || ydim1 != ydim1_update_halo_kernel5_minus_4_back_h) {
    xdim0_update_halo_kernel5_minus_4_back = xdim0;
    xdim0_update_halo_kernel5_minus_4_back_h = xdim0;
    ydim0_update_halo_kernel5_minus_4_back = ydim0;
    ydim0_update_halo_kernel5_minus_4_back_h = ydim0;
    xdim1_update_halo_kernel5_minus_4_back = xdim1;
    xdim1_update_halo_kernel5_minus_4_back_h = xdim1;
    ydim1_update_halo_kernel5_minus_4_back = ydim1;
  ...
  update_halo_kernel5_minus_4_back_c_wrapper(
    p_a0,
    p_a1,
    p_a2,
