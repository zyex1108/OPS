...
int xdim0_update_halo_kernel2_yvel_plus_4_back_h = -1;
extern int ydim0_update_halo_kernel2_yvel_plus_4_back;
int ydim0_update_halo_kernel2_yvel_plus_4_back_h = -1;
extern int xdim1_update_halo_kernel2_yvel_plus_4_back;
int xdim1_update_halo_kernel2_yvel_plus_4_back_h = -1;
extern int ydim1_update_halo_kernel2_yvel_plus_4_back;
int ydim1_update_halo_kernel2_yvel_plus_4_back_h = -1;
...
// host stub function
void ops_par_loop_update_halo_kernel2_yvel_plus_4_back(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  if (OPS_diags > 1) {
    ops_timing_realloc(89,"update_halo_kernel2_yvel_plus_4_back");
  ...
  if (xdim0 != xdim0_update_halo_kernel2_yvel_plus_4_back_h || ydim0 != ydim0_update_halo_kernel2_yvel_plus_4_back_h || xdim1 != xdim1_update_halo_kernel2_yvel_plus_4_back_h || ydim1 != ydim1_update_halo_kernel2_yvel_plus_4_back_h) {
    xdim0_update_halo_kernel2_yvel_plus_4_back = xdim0;
    xdim0_update_halo_kernel2_yvel_plus_4_back_h = xdim0;
    ydim0_update_halo_kernel2_yvel_plus_4_back = ydim0;
    ydim0_update_halo_kernel2_yvel_plus_4_back_h = ydim0;
    xdim1_update_halo_kernel2_yvel_plus_4_back = xdim1;
    xdim1_update_halo_kernel2_yvel_plus_4_back_h = xdim1;
    ydim1_update_halo_kernel2_yvel_plus_4_back = ydim1;
    ydim1_update_halo_kernel2_yvel_plus_4_back_h = ydim1;
  }
