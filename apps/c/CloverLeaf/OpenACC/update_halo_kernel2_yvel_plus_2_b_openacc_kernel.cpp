...
int xdim0_update_halo_kernel2_yvel_plus_2_b_h = -1;
extern int xdim1_update_halo_kernel2_yvel_plus_2_b;
int xdim1_update_halo_kernel2_yvel_plus_2_b_h = -1;
...
void ops_par_loop_update_halo_kernel2_yvel_plus_2_b(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  if (xdim0 != xdim0_update_halo_kernel2_yvel_plus_2_b_h || xdim1 != xdim1_update_halo_kernel2_yvel_plus_2_b_h) {
    xdim0_update_halo_kernel2_yvel_plus_2_b = xdim0;
    xdim0_update_halo_kernel2_yvel_plus_2_b_h = xdim0;
    xdim1_update_halo_kernel2_yvel_plus_2_b = xdim1;
    xdim1_update_halo_kernel2_yvel_plus_2_b_h = xdim1;
  }
  ...
  update_halo_kernel2_yvel_plus_2_b_c_wrapper(
    p_a0,
    p_a1,
    p_a2,
    x_size, y_size);
