...
extern int xdim0_update_halo_kernel2_xvel_minus_4_b;
int xdim0_update_halo_kernel2_xvel_minus_4_b_h = -1;
extern int xdim1_update_halo_kernel2_xvel_minus_4_b;
int xdim1_update_halo_kernel2_xvel_minus_4_b_h = -1;
...
void ops_par_loop_update_halo_kernel2_xvel_minus_4_b(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  if (xdim0 != xdim0_update_halo_kernel2_xvel_minus_4_b_h || xdim1 != xdim1_update_halo_kernel2_xvel_minus_4_b_h) {
    xdim0_update_halo_kernel2_xvel_minus_4_b = xdim0;
    xdim0_update_halo_kernel2_xvel_minus_4_b_h = xdim0;
    xdim1_update_halo_kernel2_xvel_minus_4_b = xdim1;
    xdim1_update_halo_kernel2_xvel_minus_4_b_h = xdim1;
  }
