...
int xdim0_update_halo_kernel2_xvel_plus_2_a_h = -1;
...
extern "C" {
#endif
void update_halo_kernel2_xvel_plus_2_a_c_wrapper(
  double *p_a0,
  double *p_a1,
  int *p_a2,
...
void ops_par_loop_update_halo_kernel2_xvel_plus_2_a(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  if (xdim0 != xdim0_update_halo_kernel2_xvel_plus_2_a_h || xdim1 != xdim1_update_halo_kernel2_xvel_plus_2_a_h) {
    xdim0_update_halo_kernel2_xvel_plus_2_a = xdim0;
    xdim0_update_halo_kernel2_xvel_plus_2_a_h = xdim0;
    xdim1_update_halo_kernel2_xvel_plus_2_a = xdim1;
    xdim1_update_halo_kernel2_xvel_plus_2_a_h = xdim1;
  }
  ...
  update_halo_kernel2_xvel_plus_2_a_c_wrapper(
    p_a0,
    p_a1,
    p_a2,
    x_size, y_size);
