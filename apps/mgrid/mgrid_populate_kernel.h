...
void mgrid_prolong_kernel(const double *coarse, double *fine, int *idx) {
  printf("idx[0] %d, idx[1] %d , fine[OPS_ACC1(0,0)] %lf, coarse[OPS_ACCP0(-1,0)] %lf, coarse[OPS_ACCP0(0,0)] %lf, coarse[OPS_ACCP0(1,0)] %lf\n",
         idx[0], idx[1], fine[OPS_ACC1(0,0)], coarse[OPS_ACCP0(-1,0)], coarse[OPS_ACCP0(0,0)], coarse[OPS_ACCP0(1,0)]);
}
*/
