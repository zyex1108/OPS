...
//user function
inline void update_halo_kernel3_plus_4_b(__global double * restrict vol_flux_x, __global double * restrict mass_flux_x, const __global int* restrict  fields)
 ...
 __kernel void ops_update_halo_kernel3_plus_4_b(
 ...
 const int size1 ){
   ...
   if (idx_x < size0 && idx_y < size1) {
     update_halo_kernel3_plus_4_b(&arg0[base0 + idx_x * 1 + idx_y * 1 * xdim0_update_halo_kernel3_plus_4_b],
                        &arg1[base1 + idx_x * 1 + idx_y * 1 * xdim1_update_halo_kernel3_plus_4_b],
                        arg2);
   }
