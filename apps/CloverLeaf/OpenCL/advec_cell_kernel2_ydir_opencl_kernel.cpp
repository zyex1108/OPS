...
static bool isbuilt_advec_cell_kernel2_ydir = false;

void buildOpenCLKernels_advec_cell_kernel2_ydir(int xdim0,
 int xdim1,
 int xdim2,
 int xdim3) {
  
  if(!isbuilt_advec_cell_kernel2_ydir) {
    buildOpenCLKernels();
    ...
    printf("Compiling advec_cell_kernel2_ydir source -- start \n");
      ...
      if (pPath!=NULL)
        sprintf(buildOpts,"-cl-mad-enable -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_advec_cell_kernel2_ydir=%d -Dxdim1_advec_cell_kernel2_ydir=%d -Dxdim2_advec_cell_kernel2_ydir=%d -Dxdim3_advec_cell_kernel2_ydir=%d", pPath, 32,xdim0,xdim1,xdim2,xdim3);
      else {
    ...
    OPS_opencl_core.kernel[12] = clCreateKernel(OPS_opencl_core.program, "ops_advec_cell_kernel2_ydir", &ret);
    clSafeCall( ret );
      
    isbuilt_advec_cell_kernel2_ydir = true;
  }
...
void ops_par_loop_advec_cell_kernel2_ydir(char const *name, ops_block Block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2, ops_arg arg3) {
  ...
  buildOpenCLKernels_advec_cell_kernel2_ydir(
  xdim0,
  xdim1,
  xdim2,
  xdim3);
  ...
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[12], 4, sizeof(cl_int), (void*) &base0 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[12], 5, sizeof(cl_int), (void*) &base1 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[12], 6, sizeof(cl_int), (void*) &base2 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[12], 7, sizeof(cl_int), (void*) &base3 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[12], 8, sizeof(cl_int), (void*) &x_size ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[12], 9, sizeof(cl_int), (void*) &y_size ));
