...
void buildOpenCLKernels_accelerate_kernel(int xdim0,
 int xdim1,
 int xdim2,
 int xdim3,
 int xdim4,
...
void ops_par_loop_accelerate_kernel(char const *name, ops_block Block, int dim, int* range,
 ...
 ops_arg arg9, ops_arg arg10) {
  ...
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[6], 11, sizeof(cl_mem), (void*) &OPS_opencl_core.constant[13]) );
  ...
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[6], 21, sizeof(cl_int), (void*) &base9 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[6], 22, sizeof(cl_int), (void*) &base10 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[6], 23, sizeof(cl_int), (void*) &x_size ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[6], 24, sizeof(cl_int), (void*) &y_size ));
