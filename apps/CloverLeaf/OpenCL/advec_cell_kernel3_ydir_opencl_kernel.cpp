...
void buildOpenCLKernels_advec_cell_kernel3_ydir(int xdim0,
 ...
 int xdim7) {
  ...
  if(!isbuilt_advec_cell_kernel3_ydir) {
    ...
    OPS_opencl_core.kernel[13] = clCreateKernel(OPS_opencl_core.program, "ops_advec_cell_kernel3_ydir", &ret);
    clSafeCall( ret );
...
void ops_par_loop_advec_cell_kernel3_ydir(char const *name, ops_block Block, int dim, int* range,
 ...
 ops_arg arg4, ops_arg arg5, ops_arg arg6, ops_arg arg7) {
  ...
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[13], 4, sizeof(cl_mem), (void*) &arg4.data_d ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[13], 5, sizeof(cl_mem), (void*) &arg5.data_d ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[13], 6, sizeof(cl_mem), (void*) &arg6.data_d ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[13], 7, sizeof(cl_mem), (void*) &arg7.data_d ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[13], 8, sizeof(cl_mem), (void*) &OPS_opencl_core.constant[6]) );
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[13], 9, sizeof(cl_int), (void*) &base0 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[13], 10, sizeof(cl_int), (void*) &base1 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[13], 11, sizeof(cl_int), (void*) &base2 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[13], 12, sizeof(cl_int), (void*) &base3 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[13], 13, sizeof(cl_int), (void*) &base4 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[13], 14, sizeof(cl_int), (void*) &base5 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[13], 15, sizeof(cl_int), (void*) &base6 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[13], 16, sizeof(cl_int), (void*) &base7 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[13], 17, sizeof(cl_int), (void*) &x_size ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[13], 18, sizeof(cl_int), (void*) &y_size ));
