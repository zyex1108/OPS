...
//user function
inline void update_halo_kernel2_xvel_plus_4_a(__global double * restrict xvel0, __global double * restrict xvel1, const __global int* restrict  fields)
 ...
 
{
 ...
 const int size1 ){
   ...
   if (idx_x < size0 && idx_y < size1) {
     update_halo_kernel2_xvel_plus_4_a(&arg0[base0 + idx_x * 1 + idx_y * 1 * xdim0_update_halo_kernel2_xvel_plus_4_a],
                        &arg1[base1 + idx_x * 1 + idx_y * 1 * xdim1_update_halo_kernel2_xvel_plus_4_a],
                        arg2);
   }
