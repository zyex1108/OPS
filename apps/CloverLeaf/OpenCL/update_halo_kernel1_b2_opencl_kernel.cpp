...
static bool isbuilt_update_halo_kernel1_b2 = false;

void buildOpenCLKernels_update_halo_kernel1_b2(int xdim0,
 int xdim1,
 int xdim2,
 int xdim3,
 int xdim4,
 ...
 int xdim6) {
  ...
  if(!isbuilt_update_halo_kernel1_b2) {
    buildOpenCLKernels();
    ...
    printf("Compiling update_halo_kernel1_b2 source -- start \n");
      ...
      printf("compiling update_halo_kernel1_b2 -- done\n");

    // Create the OpenCL kernel
    OPS_opencl_core.kernel[41] = clCreateKernel(OPS_opencl_core.program, "ops_update_halo_kernel1_b2", &ret);
    clSafeCall( ret );

    isbuilt_update_halo_kernel1_b2 = true;
  }
...
void ops_par_loop_update_halo_kernel1_b2(char const *name, ops_block Block, int dim, int* range,
 ...
 ops_arg arg4, ops_arg arg5, ops_arg arg6, ops_arg arg7) {
  ...
  buildOpenCLKernels_update_halo_kernel1_b2(
  xdim0,
  xdim1,
  xdim2,
  xdim3,
  ...
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[41], 8, sizeof(cl_int), (void*) &base0 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[41], 9, sizeof(cl_int), (void*) &base1 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[41], 10, sizeof(cl_int), (void*) &base2 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[41], 11, sizeof(cl_int), (void*) &base3 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[41], 12, sizeof(cl_int), (void*) &base4 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[41], 13, sizeof(cl_int), (void*) &base5 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[41], 14, sizeof(cl_int), (void*) &base6 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[41], 15, sizeof(cl_int), (void*) &x_size ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[41], 16, sizeof(cl_int), (void*) &y_size ));
