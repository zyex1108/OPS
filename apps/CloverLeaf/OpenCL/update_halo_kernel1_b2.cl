...
//user function
inline void update_halo_kernel1_b2(__global double * restrict density0, __global double * restrict density1, __global double * restrict energy0, 
...
const __global int* restrict  fields)
 ...
 const int size1 ){
   ...
   if (idx_x < size0 && idx_y < size1) {
     update_halo_kernel1_b2(&arg0[base0 + idx_x * 1 + idx_y * 1 * xdim0_update_halo_kernel1_b2],
                        &arg1[base1 + idx_x * 1 + idx_y * 1 * xdim1_update_halo_kernel1_b2],
                        &arg2[base2 + idx_x * 1 + idx_y * 1 * xdim2_update_halo_kernel1_b2],
                        &arg3[base3 + idx_x * 1 + idx_y * 1 * xdim3_update_halo_kernel1_b2],
                        &arg4[base4 + idx_x * 1 + idx_y * 1 * xdim4_update_halo_kernel1_b2],
                        &arg5[base5 + idx_x * 1 + idx_y * 1 * xdim5_update_halo_kernel1_b2],
                        &arg6[base6 + idx_x * 1 + idx_y * 1 * xdim6_update_halo_kernel1_b2],
                        arg7);
   }
