...
const __global double * restrict vol_flux_x, const __global double * restrict vol_flux_y)
 ...
 const int size1 ){
   ...
   if (idx_x < size0 && idx_y < size1) {
     advec_cell_kernel1_ydir(&arg0[base0 + idx_x * 1 + idx_y * 1 * xdim0_advec_cell_kernel1_ydir],
                       &arg1[base1 + idx_x * 1 + idx_y * 1 * xdim1_advec_cell_kernel1_ydir],
                       &arg2[base2 + idx_x * 1 + idx_y * 1 * xdim2_advec_cell_kernel1_ydir],
                       &arg3[base3 + idx_x * 1 + idx_y * 1 * xdim3_advec_cell_kernel1_ydir],
                       &arg4[base4 + idx_x * 1 + idx_y * 1 * xdim4_advec_cell_kernel1_ydir]);
   }
