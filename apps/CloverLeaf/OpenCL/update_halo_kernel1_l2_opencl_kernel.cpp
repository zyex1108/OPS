...
static bool isbuilt_update_halo_kernel1_l2 = false;

void buildOpenCLKernels_update_halo_kernel1_l2(int xdim0,
 int xdim1,
 int xdim2,
 int xdim3,
 int xdim4,
 ...
 int xdim6) {
  ...
  if(!isbuilt_update_halo_kernel1_l2) {
    buildOpenCLKernels();
    ...
    printf("Compiling update_halo_kernel1_l2 source -- start \n");
      ...
      printf("compiling update_halo_kernel1_l2 -- done\n");

    // Create the OpenCL kernel
    OPS_opencl_core.kernel[45] = clCreateKernel(OPS_opencl_core.program, "ops_update_halo_kernel1_l2", &ret);
    clSafeCall( ret );

    isbuilt_update_halo_kernel1_l2 = true;
  }
