...
//user function
inline void advec_mom_kernel_post_pre_advec_x( __global double * restrict node_mass_post, const __global double * restrict post_vol, const __global double * restrict density1, 
