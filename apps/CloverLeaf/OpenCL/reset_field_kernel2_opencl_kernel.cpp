...
static bool isbuilt_reset_field_kernel2 = false;

void buildOpenCLKernels_reset_field_kernel2(int xdim0,
 int xdim1,
 int xdim2,
 int xdim3) {
  ...
  if(!isbuilt_reset_field_kernel2) {
    ...
    printf("Compiling reset_field_kernel2 source -- start \n");
      ...
      if (pPath!=NULL)
        sprintf(buildOpts,"-cl-mad-enable -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_reset_field_kernel2=%d -Dxdim1_reset_field_kernel2=%d -Dxdim2_reset_field_kernel2=%d -Dxdim3_reset_field_kernel2=%d", pPath, 32,xdim0,xdim1,xdim2,xdim3);
      else {
    ...
    OPS_opencl_core.kernel[2] = clCreateKernel(OPS_opencl_core.program, "ops_reset_field_kernel2", &ret);
    clSafeCall( ret );

    isbuilt_reset_field_kernel2 = true;
  }
...
void ops_par_loop_reset_field_kernel2(char const *name, ops_block Block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2, ops_arg arg3) {
  ...
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[2], 3, sizeof(cl_mem), (void*) &arg3.data_d ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[2], 4, sizeof(cl_int), (void*) &base0 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[2], 5, sizeof(cl_int), (void*) &base1 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[2], 6, sizeof(cl_int), (void*) &base2 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[2], 7, sizeof(cl_int), (void*) &base3 ));
