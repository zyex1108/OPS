...
//user function
inline void advec_cell_kernel4_ydir( __global double * restrict density1, __global double * restrict energy1, const __global double * restrict mass_flux_y, 
const __global double * restrict vol_flux_y, const __global double * restrict pre_vol, const __global double * restrict post_vol, __global double * restrict pre_mass, 
