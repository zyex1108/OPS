...
void buildOpenCLKernels_reset_field_kernel1(int xdim0,
 int xdim1,
 int xdim2,
 int xdim3) {
  ...
  if(!isbuilt_reset_field_kernel1) {
    ...
    printf("Compiling reset_field_kernel1 source -- start \n");
      ...
      if (pPath!=NULL)
        sprintf(buildOpts,"-cl-mad-enable -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_reset_field_kernel1=%d -Dxdim1_reset_field_kernel1=%d -Dxdim2_reset_field_kernel1=%d -Dxdim3_reset_field_kernel1=%d", pPath, 32,xdim0,xdim1,xdim2,xdim3);
      else {
