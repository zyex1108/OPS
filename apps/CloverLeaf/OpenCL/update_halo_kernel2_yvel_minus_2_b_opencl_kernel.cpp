...
void buildOpenCLKernels_update_halo_kernel2_yvel_minus_2_b(int xdim0,
 int xdim1) {
  ...
  if(!isbuilt_update_halo_kernel2_yvel_minus_2_b) {
    ...
    printf("Compiling update_halo_kernel2_yvel_minus_2_b source -- start \n");
      ...
      printf("compiling update_halo_kernel2_yvel_minus_2_b -- done\n");

    // Create the OpenCL kernel
    OPS_opencl_core.kernel[60] = clCreateKernel(OPS_opencl_core.program, "ops_update_halo_kernel2_yvel_minus_2_b", &ret);
    clSafeCall( ret );
      
    isbuilt_update_halo_kernel2_yvel_minus_2_b = true;
  }
...
void ops_par_loop_update_halo_kernel2_yvel_minus_2_b(char const *name, ops_block Block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[60], 3, sizeof(cl_int), (void*) &base0 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[60], 4, sizeof(cl_int), (void*) &base1 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[60], 5, sizeof(cl_int), (void*) &x_size ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[60], 6, sizeof(cl_int), (void*) &y_size ));
