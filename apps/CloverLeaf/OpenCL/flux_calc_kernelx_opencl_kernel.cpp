...
void buildOpenCLKernels_flux_calc_kernelx(int xdim0,
 int xdim1,
 int xdim2,
 int xdim3) {
  ...
  if(!isbuilt_flux_calc_kernelx) {
    ...
    printf("Compiling flux_calc_kernelx source -- start \n");
...
void ops_par_loop_flux_calc_kernelx(char const *name, ops_block Block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2, ops_arg arg3) {
  ...
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[32], 4, sizeof(cl_mem), (void*) &OPS_opencl_core.constant[13]) );
