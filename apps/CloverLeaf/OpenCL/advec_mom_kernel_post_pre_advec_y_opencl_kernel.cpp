...
static bool isbuilt_advec_mom_kernel_post_pre_advec_y = false;

void buildOpenCLKernels_advec_mom_kernel_post_pre_advec_y(int xdim0,
 int xdim1,
 int xdim2,
 int xdim3,
 int xdim4) {
  ...
  if(!isbuilt_advec_mom_kernel_post_pre_advec_y) {
    ...
    printf("Compiling advec_mom_kernel_post_pre_advec_y source -- start \n");
      ...
      printf("compiling advec_mom_kernel_post_pre_advec_y -- done\n");

    // Create the OpenCL kernel
    OPS_opencl_core.kernel[24] = clCreateKernel(OPS_opencl_core.program, "ops_advec_mom_kernel_post_pre_advec_y", &ret);
    clSafeCall( ret );

    isbuilt_advec_mom_kernel_post_pre_advec_y = true;
  }
...
void ops_par_loop_advec_mom_kernel_post_pre_advec_y(char const *name, ops_block Block, int dim, int* range,
 ...
 ops_arg arg4) {
  ...
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[24], 5, sizeof(cl_int), (void*) &base0 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[24], 6, sizeof(cl_int), (void*) &base1 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[24], 7, sizeof(cl_int), (void*) &base2 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[24], 8, sizeof(cl_int), (void*) &base3 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[24], 9, sizeof(cl_int), (void*) &base4 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[24], 10, sizeof(cl_int), (void*) &x_size ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[24], 11, sizeof(cl_int), (void*) &y_size ));
