...
void buildOpenCLKernels_advec_mom_kernel_x2(int xdim0,
 int xdim1,
 int xdim2,
 int xdim3) {
  ...
  if(!isbuilt_advec_mom_kernel_x2) {
    ...
    printf("Compiling advec_mom_kernel_x2 source -- start \n");
      ...
      if (pPath!=NULL)
        sprintf(buildOpts,"-cl-mad-enable -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_advec_mom_kernel_x2=%d -Dxdim1_advec_mom_kernel_x2=%d -Dxdim2_advec_mom_kernel_x2=%d -Dxdim3_advec_mom_kernel_x2=%d", pPath, 32,xdim0,xdim1,xdim2,xdim3);
      else {
      ...
      printf("compiling advec_mom_kernel_x2 -- done\n");

    // Create the OpenCL kernel
    OPS_opencl_core.kernel[17] = clCreateKernel(OPS_opencl_core.program, "ops_advec_mom_kernel_x2", &ret);
    clSafeCall( ret );
