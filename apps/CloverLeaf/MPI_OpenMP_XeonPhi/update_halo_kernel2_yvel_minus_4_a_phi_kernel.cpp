...
void ops_par_loop_update_halo_kernel2_yvel_minus_4_a(char const *name, ops_block Block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  //Timing
  double t1,t2,c1,c2;
  ops_timing_realloc(46,"update_halo_kernel2_yvel_minus_4_a");
  ops_timers_core(&c2,&t2);

  if (OPS_kernels[46].count == 0) {
    xdim0_update_halo_kernel2_yvel_minus_4_a = args[0].dat->block_size[0]*args[0].dat->dim;
    xdim1_update_halo_kernel2_yvel_minus_4_a = args[1].dat->block_size[0]*args[1].dat->dim;
  }
  ...
  update_halo_kernel2_yvel_minus_4_a_c_wrapper(
    p_a0,
    p_a1,
    p_a2,
    x_size, y_size);
