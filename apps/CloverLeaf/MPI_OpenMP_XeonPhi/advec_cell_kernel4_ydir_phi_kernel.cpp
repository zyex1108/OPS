...
void ops_par_loop_advec_cell_kernel4_ydir(char const *name, ops_block Block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2, ops_arg arg3, ops_arg arg4, ops_arg arg5, ops_arg arg6, ops_arg arg7, ops_arg arg8, ops_arg arg9, ops_arg arg10) {
  ...
  if (OPS_kernels[29].count == 0) {
    xdim0_advec_cell_kernel4_ydir = args[0].dat->block_size[0]*args[0].dat->dim;
    xdim1_advec_cell_kernel4_ydir = args[1].dat->block_size[0]*args[1].dat->dim;
    xdim2_advec_cell_kernel4_ydir = args[2].dat->block_size[0]*args[2].dat->dim;
    xdim3_advec_cell_kernel4_ydir = args[3].dat->block_size[0]*args[3].dat->dim;
    xdim4_advec_cell_kernel4_ydir = args[4].dat->block_size[0]*args[4].dat->dim;
    xdim5_advec_cell_kernel4_ydir = args[5].dat->block_size[0]*args[5].dat->dim;
    xdim6_advec_cell_kernel4_ydir = args[6].dat->block_size[0]*args[6].dat->dim;
    xdim7_advec_cell_kernel4_ydir = args[7].dat->block_size[0]*args[7].dat->dim;
    xdim8_advec_cell_kernel4_ydir = args[8].dat->block_size[0]*args[8].dat->dim;
    xdim9_advec_cell_kernel4_ydir = args[9].dat->block_size[0]*args[9].dat->dim;
    xdim10_advec_cell_kernel4_ydir = args[10].dat->block_size[0]*args[10].dat->dim;
  }
