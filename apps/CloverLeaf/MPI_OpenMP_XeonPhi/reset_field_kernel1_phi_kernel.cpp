...
void ops_par_loop_reset_field_kernel1(char const *name, ops_block Block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2, ops_arg arg3) {
  ...
  if (OPS_kernels[3].count == 0) {
    xdim0_reset_field_kernel1 = args[0].dat->block_size[0]*args[0].dat->dim;
    xdim1_reset_field_kernel1 = args[1].dat->block_size[0]*args[1].dat->dim;
    xdim2_reset_field_kernel1 = args[2].dat->block_size[0]*args[2].dat->dim;
    xdim3_reset_field_kernel1 = args[3].dat->block_size[0]*args[3].dat->dim;
  }
