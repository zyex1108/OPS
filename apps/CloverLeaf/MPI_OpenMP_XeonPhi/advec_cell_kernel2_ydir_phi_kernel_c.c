...
void advec_cell_kernel2_ydir_c_wrapper(
  ...
  for ( int n_y=0; n_y<y_size; n_y++ ){
    ...
    for ( int n_x=0; n_x<x_size; n_x++ ){
      advec_cell_kernel2_ydir(  p_a0 + n_x*1 + n_y*xdim0_advec_cell_kernel2_ydir*1,
           p_a1 + n_x*1 + n_y*xdim1_advec_cell_kernel2_ydir*1, p_a2 + n_x*1 + n_y*xdim2_advec_cell_kernel2_ydir*1,
           p_a3 + n_x*1 + n_y*xdim3_advec_cell_kernel2_ydir*1 );
