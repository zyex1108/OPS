...
void ops_par_loop_update_halo_kernel2_xvel_minus_2_b(char const *name, ops_block Block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  if (OPS_kernels[45].count == 0) {
    xdim0_update_halo_kernel2_xvel_minus_2_b = args[0].dat->block_size[0]*args[0].dat->dim;
    xdim1_update_halo_kernel2_xvel_minus_2_b = args[1].dat->block_size[0]*args[1].dat->dim;
  }
