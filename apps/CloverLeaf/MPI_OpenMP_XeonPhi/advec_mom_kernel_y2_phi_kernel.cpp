...
void ops_par_loop_advec_mom_kernel_y2(char const *name, ops_block Block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2, ops_arg arg3) {
  ...
  //Timing
  double t1,t2,c1,c2;
  ops_timing_realloc(13,"advec_mom_kernel_y2");
  ops_timers_core(&c2,&t2);

  if (OPS_kernels[13].count == 0) {
    xdim0_advec_mom_kernel_y2 = args[0].dat->block_size[0]*args[0].dat->dim;
    xdim1_advec_mom_kernel_y2 = args[1].dat->block_size[0]*args[1].dat->dim;
    xdim2_advec_mom_kernel_y2 = args[2].dat->block_size[0]*args[2].dat->dim;
    xdim3_advec_mom_kernel_y2 = args[3].dat->block_size[0]*args[3].dat->dim;
  }
