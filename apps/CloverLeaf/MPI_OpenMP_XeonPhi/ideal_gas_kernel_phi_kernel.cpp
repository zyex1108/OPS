...
void ops_par_loop_ideal_gas_kernel(char const *name, ops_block Block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2, ops_arg arg3) {
  ...
  if (OPS_kernels[7].count == 0) {
    xdim0_ideal_gas_kernel = args[0].dat->block_size[0]*args[0].dat->dim;
    xdim1_ideal_gas_kernel = args[1].dat->block_size[0]*args[1].dat->dim;
    xdim2_ideal_gas_kernel = args[2].dat->block_size[0]*args[2].dat->dim;
    xdim3_ideal_gas_kernel = args[3].dat->block_size[0]*args[3].dat->dim;
  }
