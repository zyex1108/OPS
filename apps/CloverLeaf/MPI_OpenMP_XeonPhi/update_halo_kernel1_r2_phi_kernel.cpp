...
void ops_par_loop_update_halo_kernel1_r2(char const *name, ops_block Block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2, ops_arg arg3, ops_arg arg4, ops_arg arg5, ops_arg arg6, ops_arg arg7) {
  ...
  //Timing
  double t1,t2,c1,c2;
  ops_timing_realloc(36,"update_halo_kernel1_r2");
  ops_timers_core(&c2,&t2);

  if (OPS_kernels[36].count == 0) {
    xdim0_update_halo_kernel1_r2 = args[0].dat->block_size[0]*args[0].dat->dim;
    xdim1_update_halo_kernel1_r2 = args[1].dat->block_size[0]*args[1].dat->dim;
    xdim2_update_halo_kernel1_r2 = args[2].dat->block_size[0]*args[2].dat->dim;
    xdim3_update_halo_kernel1_r2 = args[3].dat->block_size[0]*args[3].dat->dim;
    xdim4_update_halo_kernel1_r2 = args[4].dat->block_size[0]*args[4].dat->dim;
    xdim5_update_halo_kernel1_r2 = args[5].dat->block_size[0]*args[5].dat->dim;
    xdim6_update_halo_kernel1_r2 = args[6].dat->block_size[0]*args[6].dat->dim;
  }
