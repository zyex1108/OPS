...
void ops_par_loop_advec_mom_kernel_post_pre_advec_x(char const *name, ops_block Block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2, ops_arg arg3, ops_arg arg4) {
  ...
  //Timing
  double t1,t2,c1,c2;
  ops_timing_realloc(15,"advec_mom_kernel_post_pre_advec_x");
  ops_timers_core(&c2,&t2);

  if (OPS_kernels[15].count == 0) {
    xdim0_advec_mom_kernel_post_pre_advec_x = args[0].dat->block_size[0]*args[0].dat->dim;
    xdim1_advec_mom_kernel_post_pre_advec_x = args[1].dat->block_size[0]*args[1].dat->dim;
    xdim2_advec_mom_kernel_post_pre_advec_x = args[2].dat->block_size[0]*args[2].dat->dim;
    xdim3_advec_mom_kernel_post_pre_advec_x = args[3].dat->block_size[0]*args[3].dat->dim;
    xdim4_advec_mom_kernel_post_pre_advec_x = args[4].dat->block_size[0]*args[4].dat->dim;
  }
