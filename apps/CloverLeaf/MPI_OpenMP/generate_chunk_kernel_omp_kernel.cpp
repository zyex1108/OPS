...
void ops_par_loop_generate_chunk_kernel(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4, ops_arg arg5, ops_arg arg6, ops_arg arg7) {
    ...
    for ( int n_y=start_i; n_y<finish_i; n_y++ ){
      for ( int n_x=start[0]; n_x<start[0]+(end[0]-start[0])/SIMD_VEC; n_x++ ){
        ...
        for ( int i=0; i<SIMD_VEC; i++ ){
          generate_chunk_kernel(  (const double * )p_a[0]+ i*1, (const double * )p_a[1]+ i*0, (double * )p_a[2]+ i*1,
           (double * )p_a[3]+ i*1, (double * )p_a[4]+ i*1, (double * )p_a[5]+ i*1, (const double * )p_a[6]+ i*1,
           (const double * )p_a[7]+ i*0 );
  ...
  #ifdef OPS_DEBUG
  ops_dump3(arg2.dat,"generate_chunk_kernel");
  ops_dump3(arg3.dat,"generate_chunk_kernel");
  ops_dump3(arg4.dat,"generate_chunk_kernel");
  ops_dump3(arg5.dat,"generate_chunk_kernel");
  #endif
