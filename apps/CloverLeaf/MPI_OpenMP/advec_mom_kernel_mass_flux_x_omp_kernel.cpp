...
void ops_par_loop_advec_mom_kernel_mass_flux_x(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1) {
    ...
    for ( int n_y=start_i; n_y<finish_i; n_y++ ){
      for ( int n_x=start[0]; n_x<start[0]+(end[0]-start[0])/SIMD_VEC; n_x++ ){
        ...
        for ( int i=0; i<SIMD_VEC; i++ ){
          advec_mom_kernel_mass_flux_x(  (double * )p_a[0]+ i*1, (const double * )p_a[1]+ i*1 );
      ...
      for ( int n_x=start[0]+((end[0]-start[0])/SIMD_VEC)*SIMD_VEC; n_x<end[0]; n_x++ ){
        ...
        advec_mom_kernel_mass_flux_x(  (double * )p_a[0], (const double * )p_a[1] );
  ...
  #ifdef OPS_DEBUG
  ops_dump3(arg0.dat,"advec_mom_kernel_mass_flux_x");
  #endif
