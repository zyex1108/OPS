...
void ops_par_loop_PdV_kernel_nopredict(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg12, ops_arg arg13) {
  ...
  for ( int thr=0; thr<nthreads; thr++ ){
    ...
    int base11 = dat11 * 1 * 
    (start0 * args[11].stencil->stride[0] - args[11].dat->base[0] - args[11].dat->d_m[0]);
    base11 = base11+ dat11 *
      args[11].dat->size[0] *
      (start1 * args[11].stencil->stride[1] - args[11].dat->base[1] - args[11].dat->d_m[1]);
    p_a[11] = (char *)args[11].data + base11;

    int base12 = dat12 * 1 * 
    (start0 * args[12].stencil->stride[0] - args[12].dat->base[0] - args[12].dat->d_m[0]);
    base12 = base12+ dat12 *
      args[12].dat->size[0] *
      (start1 * args[12].stencil->stride[1] - args[12].dat->base[1] - args[12].dat->d_m[1]);
    p_a[12] = (char *)args[12].data + base12;

    int base13 = dat13 * 1 * 
    (start0 * args[13].stencil->stride[0] - args[13].dat->base[0] - args[13].dat->d_m[0]);
    base13 = base13+ dat13 *
      args[13].dat->size[0] *
      (start1 * args[13].stencil->stride[1] - args[13].dat->base[1] - args[13].dat->d_m[1]);
    ...
    for ( int n_y=start_i; n_y<finish_i; n_y++ ){
      for ( int n_x=start[0]; n_x<start[0]+(end[0]-start[0])/SIMD_VEC; n_x++ ){
        ...
        for ( int i=0; i<SIMD_VEC; i++ ){
          PdV_kernel_nopredict(  (const double * )p_a[0]+ i*1, (const double * )p_a[1]+ i*1, (const double * )p_a[2]+ i*1,
           ...
           (const double * )p_a[11]+ i*1, (const double * )p_a[12]+ i*1, (double * )p_a[13]+ i*1 );
      ...
      for ( int n_x=start[0]+((end[0]-start[0])/SIMD_VEC)*SIMD_VEC; n_x<end[0]; n_x++ ){
        ...
        PdV_kernel_nopredict(  (const double * )p_a[0], (const double * )p_a[1], (const double * )p_a[2],
           ...
           (const double * )p_a[11], (const double * )p_a[12], (double * )p_a[13] );
