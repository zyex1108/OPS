...
void ops_par_loop_update_halo_kernel2_yvel_minus_4_a(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
    ...
    for ( int n_y=start_i; n_y<finish_i; n_y++ ){
      for ( int n_x=start[0]; n_x<start[0]+(end[0]-start[0])/SIMD_VEC; n_x++ ){
        ...
        for ( int i=0; i<SIMD_VEC; i++ ){
          update_halo_kernel2_yvel_minus_4_a(  (double * )p_a[0]+ i*1, (double * )p_a[1]+ i*1, &arg_gbl2[64*thr] );
      ...
      for ( int n_x=start[0]+((end[0]-start[0])/SIMD_VEC)*SIMD_VEC; n_x<end[0]; n_x++ ){
        ...
        update_halo_kernel2_yvel_minus_4_a(  (double * )p_a[0], (double * )p_a[1], &arg_gbl2[64*thr] );
  ...
  #ifdef OPS_DEBUG
  ops_dump3(arg0.dat,"update_halo_kernel2_yvel_minus_4_a");
  ops_dump3(arg1.dat,"update_halo_kernel2_yvel_minus_4_a");
  #endif
