...
void ops_par_loop_initialise_chunk_kernel_y(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  for ( int thr=0; thr<nthreads; thr++ ){
    ...
    for ( int n_y=start_i; n_y<finish_i; n_y++ ){
      ...
      for ( int n_x=start[0]+((end[0]-start[0])/SIMD_VEC)*SIMD_VEC; n_x<end[0]; n_x++ ){
        ...
        initialise_chunk_kernel_y(  (double * )p_a[0], (const int * )p_a[1], (double * )p_a[2] );
  ...
  #ifdef OPS_DEBUG
  ops_dump3(arg0.dat,"initialise_chunk_kernel_y");
  ops_dump3(arg2.dat,"initialise_chunk_kernel_y");
  #endif
