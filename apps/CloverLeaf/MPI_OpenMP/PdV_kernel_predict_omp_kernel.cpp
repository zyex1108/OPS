...
void ops_par_loop_PdV_kernel_predict(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg8, ops_arg arg9, ops_arg arg10, ops_arg arg11) {
  ...
  for ( int thr=0; thr<nthreads; thr++ ){
    ...
    for ( int n_y=start_i; n_y<finish_i; n_y++ ){
      ...
      for ( int n_x=start[0]+((end[0]-start[0])/SIMD_VEC)*SIMD_VEC; n_x<end[0]; n_x++ ){
        ...
        PdV_kernel_predict(  (const double * )p_a[0], (const double * )p_a[1], (const double * )p_a[2],
           (const double * )p_a[3], (double * )p_a[4], (const double * )p_a[5], (const double * )p_a[6],
           (const double * )p_a[7], (double * )p_a[8], (const double * )p_a[9], (const double * )p_a[10],
           (double * )p_a[11] );
  ...
  #ifdef OPS_DEBUG
  ops_dump3(arg4.dat,"PdV_kernel_predict");
  ops_dump3(arg8.dat,"PdV_kernel_predict");
  ops_dump3(arg11.dat,"PdV_kernel_predict");
  #endif
