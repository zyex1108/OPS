...
void ops_par_loop_field_summary_kernel(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg8, ops_arg arg9, ops_arg arg10) {
    ...
    for ( int n_y=start_i; n_y<finish_i; n_y++ ){
      ...
      for ( int n_x=start[0]+((end[0]-start[0])/SIMD_VEC)*SIMD_VEC; n_x<end[0]; n_x++ ){
        ...
        field_summary_kernel(  (const double * )p_a[0], (const double * )p_a[1], (const double * )p_a[2],
           (const double * )p_a[3], (const double * )p_a[4], (const double * )p_a[5], &arg_gbl6[64*thr],
           &arg_gbl7[64*thr], &arg_gbl8[64*thr], &arg_gbl9[64*thr], &arg_gbl10[64*thr] );
  ...
  ops_mpi_reduce(&arg7,(double *)arg7h);
  ops_mpi_reduce(&arg8,(double *)arg8h);
  ops_mpi_reduce(&arg9,(double *)arg9h);
  ops_mpi_reduce(&arg10,(double *)arg10h);
