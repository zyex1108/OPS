...
void ops_par_loop_accelerate_kernel(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg8, ops_arg arg9, ops_arg arg10) {
    ...
    for ( int n_y=start_i; n_y<finish_i; n_y++ ){
      for ( int n_x=start[0]; n_x<start[0]+(end[0]-start[0])/SIMD_VEC; n_x++ ){
        ...
        for ( int i=0; i<SIMD_VEC; i++ ){
          accelerate_kernel(  (const double * )p_a[0]+ i*1, (const double * )p_a[1]+ i*1, (double * )p_a[2]+ i*1,
      ...
      for ( int n_x=start[0]+((end[0]-start[0])/SIMD_VEC)*SIMD_VEC; n_x<end[0]; n_x++ ){
        ...
        accelerate_kernel(  (const double * )p_a[0], (const double * )p_a[1], (double * )p_a[2],
  ...
  #ifdef OPS_DEBUG
  ops_dump3(arg2.dat,"accelerate_kernel");
  ops_dump3(arg4.dat,"accelerate_kernel");
  ops_dump3(arg8.dat,"accelerate_kernel");
  #endif
