...
int size1 ){
  ...
  arg0 += idx_x * 1 + idx_y * 1 * xdim0_update_halo_kernel4_plus_2_a;
  arg1 += idx_x * 1 + idx_y * 1 * xdim1_update_halo_kernel4_plus_2_a;
...
void ops_par_loop_update_halo_kernel4_plus_2_a(char const *name, ops_block Block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  ops_update_halo_kernel4_plus_2_a<<<grid, block >>> (  (double *)p_a[0], (double *)p_a[1],
