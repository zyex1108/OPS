...
__constant__ int xdim0_update_halo_kernel2_xvel_minus_4_a;
__constant__ int xdim1_update_halo_kernel2_xvel_minus_4_a;
...
int size1 ){
  ...
  arg0 += idx_x * 1 + idx_y * 1 * xdim0_update_halo_kernel2_xvel_minus_4_a;
  arg1 += idx_x * 1 + idx_y * 1 * xdim1_update_halo_kernel2_xvel_minus_4_a;
...
void ops_par_loop_update_halo_kernel2_xvel_minus_4_a(char const *name, ops_block Block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  if (OPS_kernels[53].count == 0) {
    cudaMemcpyToSymbol( xdim0_update_halo_kernel2_xvel_minus_4_a, &xdim0, sizeof(int) );
    cudaMemcpyToSymbol( xdim1_update_halo_kernel2_xvel_minus_4_a, &xdim1, sizeof(int) );
  }
  ...
  ops_update_halo_kernel2_xvel_minus_4_a<<<grid, block >>> (  (double *)p_a[0], (double *)p_a[1],
