...
int size1 ){
  ...
  arg0 += idx_x * 1 + idx_y * 1 * xdim0_advec_mom_kernel_post_pre_advec_y;
  arg1 += idx_x * 1 + idx_y * 1 * xdim1_advec_mom_kernel_post_pre_advec_y;
  arg2 += idx_x * 1 + idx_y * 1 * xdim2_advec_mom_kernel_post_pre_advec_y;
  arg3 += idx_x * 1 + idx_y * 1 * xdim3_advec_mom_kernel_post_pre_advec_y;
  arg4 += idx_x * 1 + idx_y * 1 * xdim4_advec_mom_kernel_post_pre_advec_y;
