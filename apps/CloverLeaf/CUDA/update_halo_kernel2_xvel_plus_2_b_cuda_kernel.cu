...
__constant__ int xdim0_update_halo_kernel2_xvel_plus_2_b;
__constant__ int xdim1_update_halo_kernel2_xvel_plus_2_b;

#define OPS_ACC0(x,y) (x+xdim0_update_halo_kernel2_xvel_plus_2_b*(y))
#define OPS_ACC1(x,y) (x+xdim1_update_halo_kernel2_xvel_plus_2_b*(y))
...
__global__ void ops_update_halo_kernel2_xvel_plus_2_b(
...
int size1 ){
  ...
  arg0 += idx_x * 1 + idx_y * 1 * xdim0_update_halo_kernel2_xvel_plus_2_b;
  arg1 += idx_x * 1 + idx_y * 1 * xdim1_update_halo_kernel2_xvel_plus_2_b;

  if (idx_x < size0 && idx_y < size1) {
    update_halo_kernel2_xvel_plus_2_b(arg0, arg1, arg2);
  }
...
void ops_par_loop_update_halo_kernel2_xvel_plus_2_b(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  ops_update_halo_kernel2_xvel_plus_2_b<<<grid, tblock >>> (  (double *)p_a[0], (double *)p_a[1],
