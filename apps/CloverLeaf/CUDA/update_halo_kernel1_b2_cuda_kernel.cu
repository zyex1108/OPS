...
int size1 ){
  ...
  arg0 += idx_x * 1 + idx_y * 1 * xdim0_update_halo_kernel1_b2;
  arg1 += idx_x * 1 + idx_y * 1 * xdim1_update_halo_kernel1_b2;
  arg2 += idx_x * 1 + idx_y * 1 * xdim2_update_halo_kernel1_b2;
  arg3 += idx_x * 1 + idx_y * 1 * xdim3_update_halo_kernel1_b2;
  arg4 += idx_x * 1 + idx_y * 1 * xdim4_update_halo_kernel1_b2;
  arg5 += idx_x * 1 + idx_y * 1 * xdim5_update_halo_kernel1_b2;
  arg6 += idx_x * 1 + idx_y * 1 * xdim6_update_halo_kernel1_b2;

  if (idx_x < size0 && idx_y < size1) {
    update_halo_kernel1_b2(arg0, arg1, arg2, arg3,
                   arg4, arg5, arg6, arg7);
  }
...
void ops_par_loop_update_halo_kernel1_b2(char const *name, ops_block Block, int dim, int* range,
 ...
 ops_arg arg4, ops_arg arg5, ops_arg arg6, ops_arg arg7) {
  ...
  ops_update_halo_kernel1_b2<<<grid, block >>> (  (double *)p_a[0], (double *)p_a[1],
