...
int size1 ){
  ...
  arg0 += idx_x * 1 + idx_y * 1 * xdim0_update_halo_kernel3_minus_4_a;
  arg1 += idx_x * 1 + idx_y * 1 * xdim1_update_halo_kernel3_minus_4_a;

  if (idx_x < size0 && idx_y < size1) {
    update_halo_kernel3_minus_4_a(arg0, arg1, arg2);
  }
...
void ops_par_loop_update_halo_kernel3_minus_4_a(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  ops_update_halo_kernel3_minus_4_a<<<grid, tblock >>> (  (double *)p_a[0], (double *)p_a[1],
