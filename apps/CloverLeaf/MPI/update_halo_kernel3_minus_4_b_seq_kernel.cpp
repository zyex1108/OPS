...
void ops_par_loop_update_halo_kernel3_minus_4_b_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for( n_x=start[0]; n_x<start[0]+((end[0]-start[0])/SIMD_VEC)*SIMD_VEC; n_x+=SIMD_VEC ) {
      ...
      for ( int i=0; i<SIMD_VEC; i++ ){
        update_halo_kernel3_minus_4_b(  (double *)p_a[0]+ i*1, (double *)p_a[1]+ i*1, (int *)p_a[2] );
  ...
  #ifdef OPS_DEBUG
  ops_dump3(arg0.dat,"update_halo_kernel3_minus_4_b");
  ops_dump3(arg1.dat,"update_halo_kernel3_minus_4_b");
  #endif
