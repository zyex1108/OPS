...
void update_halo_kernel1_t1_c_wrapper(
  ...
  for ( int n_y=0; n_y<y_size; n_y++ ){
    ...
    for ( int n_x=0; n_x<x_size; n_x++ ){
      update_halo_kernel1_t1(  p_a0 + n_x*1 + n_y*xdim0_update_halo_kernel1_t1*1,
           p_a1 + n_x*1 + n_y*xdim1_update_halo_kernel1_t1*1, p_a2 + n_x*1 + n_y*xdim2_update_halo_kernel1_t1*1,
           p_a3 + n_x*1 + n_y*xdim3_update_halo_kernel1_t1*1, p_a4 + n_x*1 + n_y*xdim4_update_halo_kernel1_t1*1,
           p_a5 + n_x*1 + n_y*xdim5_update_halo_kernel1_t1*1, p_a6 + n_x*1 + n_y*xdim6_update_halo_kernel1_t1*1,
           p_a7 );
