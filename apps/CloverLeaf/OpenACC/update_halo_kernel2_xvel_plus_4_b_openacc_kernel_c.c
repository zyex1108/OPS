...
void update_halo_kernel2_xvel_plus_4_b_c_wrapper(
  ...
  for ( int n_y=0; n_y<y_size; n_y++ ){
    ...
    for ( int n_x=0; n_x<x_size; n_x++ ){
      update_halo_kernel2_xvel_plus_4_b(  p_a0 + n_x*1 + n_y*xdim0_update_halo_kernel2_xvel_plus_4_b*1,
           p_a1 + n_x*1 + n_y*xdim1_update_halo_kernel2_xvel_plus_4_b*1, p_a2 );
