...
void advec_mom_kernel_post_pre_advec_y_c_wrapper(
  ...
  for ( int n_y=0; n_y<y_size; n_y++ ){
    ...
    for ( int n_x=0; n_x<x_size; n_x++ ){
      advec_mom_kernel_post_pre_advec_y(  p_a0 + n_x*1 + n_y*xdim0_advec_mom_kernel_post_pre_advec_y*1,
           p_a1 + n_x*1 + n_y*xdim1_advec_mom_kernel_post_pre_advec_y*1, p_a2 + n_x*1 + n_y*xdim2_advec_mom_kernel_post_pre_advec_y*1,
           p_a3 + n_x*1 + n_y*xdim3_advec_mom_kernel_post_pre_advec_y*1, p_a4 + n_x*1 + n_y*xdim4_advec_mom_kernel_post_pre_advec_y*1 );
