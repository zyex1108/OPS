...
void ops_par_loop_advec_cell_kernel3_xdir(char const *name, ops_block Block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2, ops_arg arg3, ops_arg arg4, ops_arg arg5, ops_arg arg6, ops_arg arg7) {
  ...
  if (OPS_kernels[9].count == 0) {
    xdim0_advec_cell_kernel3_xdir = args[0].dat->size[0]*args[0].dat->dim;
    xdim1_advec_cell_kernel3_xdir = args[1].dat->size[0]*args[1].dat->dim;
    xdim2_advec_cell_kernel3_xdir = args[2].dat->size[0]*args[2].dat->dim;
    xdim3_advec_cell_kernel3_xdir = args[3].dat->size[0]*args[3].dat->dim;
    xdim4_advec_cell_kernel3_xdir = args[4].dat->size[0]*args[4].dat->dim;
    xdim5_advec_cell_kernel3_xdir = args[5].dat->size[0]*args[5].dat->dim;
    xdim6_advec_cell_kernel3_xdir = args[6].dat->size[0]*args[6].dat->dim;
    xdim7_advec_cell_kernel3_xdir = args[7].dat->size[0]*args[7].dat->dim;
  }
